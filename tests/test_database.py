...
class ORMCreateSchemaTestCase(TestCase):
    ...
    def test_create_schema(self):
        ...
        self.assertTrue(Base.metadata.tables[BranchProduct.__tablename__].exists(self.engine))
...
class ORMCreateExampleDataTestCase(TestCase):
    ...
    def test_create_example_product(self):
        ...
        some_product = Product(
            ...
            package="24 x 500ml",
            image_urls="https://i5.walmartimages.ca/images/Large/887/928/999999-60538887928.jpg,https://i5.walmartimages.ca/images/Large/089/6_1/400896_1.jpg,https://i5.walmartimages.ca/images/Large/88_/nft/605388879288_NFT.jpg",
        )
    ...
    def test_store_sku_unique(self):
        ...
        some_product_a = Product(
            store="STR01",
            sku="SKU001",
            name="Some Name",
        )

        some_product_b = Product(
            store="STR02",
            sku="SKU001",
            name="Some Name",
        )

        some_product_c = Product(
            store="STR01",
            sku="SKU001",
            name="Some Name",
        )
